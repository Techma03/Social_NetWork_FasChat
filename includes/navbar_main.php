...
<style type="text/css">
    ...
    @media(min-width:1024px){
        .footer{
            background:blue;margin-left:-30px;
...
<nav class="navbar navbar-inverse" style="position:fixed;top:0;right:0;left:0;z-index: 2;">
    <div class="container-fluid" style="width: 1040px;">
        <div class="navbar-header" style="float: <?php echo lang('float'); ?>;">
            <button type="button" id="bar" class="navbar-toggle"  >
                <span class="icon-bar"></span>
                <span class="icon-bar"></span>
                <span class="icon-bar"></span>
            </button>
            <button type="button" id="close" class="navbar-toggle" style="padding:1px;"  >
               <img style="width:40px;height:31px;"  src="imgs/main_icons/close.png">
               
            </button>
           
            <a class="navbar-brand" href="<?php echo $dircheckPath; ?>home">FasChat</a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="<?php echo lang('ul_navbar_nav1'); ?>">
                ...
                <div id='sqresultItem'  style='background: #efefef;align:center; border: 1px solid #e0e0e0;'>
                ...
                <li><a href="users" style="padding: 16px 10px;"><span class="fa fa-user"></span> Users <span id="messagesCount"></span></a>
                </li>
            </ul>
    ...
    <div id="menu_bar" style="background:rgb(0,67,100);height:470px;
    width:200px;position:absolute;
    display:none;">
    <a href="u/<?php echo $_SESSION['Username']; ?>">
    <img style="width:70px;position:relative;left:63px;bottom:-10px; height:70px;border-radius:40px;" src="<?php echo 'imgs/user_imgs/'.$_SESSION['Userphoto']; ?>">
     
  </a>
  <span style="color:black;">
  <h3 style=" margin:5px;font-size:18px;position:relative;left:43px;bottom:-10px;"><?php echo "<a style='color:rgb(174,174,174);' href='u/".$_SESSION['Username']."'>".$_SESSION['Fullname']."</a>"; if ($_SESSION['verify'] == "1"){echo $verifyUser;} ?></h3>
 </span>

<p align="center" style="position:relative;bottom:-5px;left:3px;color:rgb(193,193,193);">@<?php echo $_SESSION['Username'];?></p>
   <div align="center" style="background-color:rgb(163,163,163);height:35px;width:191px;padding:7px;position:relative;left:5px;">
   Edit profile
   </div>
   <p></p>
   <nav class="menu_bar">
   <ul>
   <li class="btn2"><a href="home"><p align="center">My Photos</p></a></li> 
   <li class="btn2"><a href="Notifications"><p align="center">Settings</p></a></li>
   <li class="btn2"><a href="messages"><p align="center">Language</p></a></li> 
   <li class="btn2"><a href="users"><p align="center">Users</p></a></li>    
   <li class="btn2"><a href="logout"><p align="center">Logout</p></a></li> 
   </ul>
...
$("#close").click(function(){
    $("#bar").show();
    $("#close").hide();
    $("#menu_bar").hide('normal');
})
$(".footer").css({"margin-top":"500px","position":"fixed"})
</script>
