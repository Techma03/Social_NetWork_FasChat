...
<head>
    <title><? echo lang('create_new_account'); ?> | FasChat</title>
    <meta charset="UTF-8">
    ...
    <meta name="keywords" content="signup,social network,social media,FasChat,meet,free platform">
    ...
    <!--============[ main contains ]============-->
        ...
        <span class="spn"><span>
        <!--============[ login sec ]============-->
        <div id="footer" style="background: #fff; border-radius: 3px; width: 420px; padding: 15px; margin: 15px;color: #7b7b7b;" align="center">
            <? echo lang('already_have_an_account'); ?> <a href="index"><? echo lang('login_now'); ?></a>.<hr style="margin: 8px;">
