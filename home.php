...
<head>
    ...
    <meta name="keywords" content="social network,social media,FasChat,meet,free platform">
...
<style>
    ...
    @media(max-width:1024px){
        ...
        #col2{
            margin-right:0px;margin-left:-1008px;position:relative;
            left:1010px;max-width:290px;
        }
       
        .footer{
           
            background:blue;margin-left:-30px; width:335px;height:50px;
        }
        .fil{
          position:relative;
          left:-20px;
